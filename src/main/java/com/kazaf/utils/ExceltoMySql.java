...
public class ExceltoMySql {
    ...
    public List<Bill> getBillbyMonth(Date startday,Date enddate){
        List<Bill> billList=ems.getCommonDao().getBillbyMonth(startday,enddate);
        ems.getSession().commit();
        ems.CloseMysql();
        return billList;
    }
